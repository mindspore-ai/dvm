...
def test_slice_dit_00():
    t = Tester()
    a = Tester.fast_random_normal(0, 1, (1, 14, 41850, 40)).astype(np.float16)
    b = Tester.fast_random_normal(0, 1, (2, 1, 41850, 80)).astype(np.float16)
    c = Tester.fast_random_normal(0, 1, (1, 14, 41850, 40)).astype(np.float16)
    x = t.load(a)
    x = t.cast(x, "float32")
