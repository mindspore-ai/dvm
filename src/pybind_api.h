...
class RtKernelPy : public KernelPy {
 public:
  ...
  py::object GatherLoad(py::object shape, py::object index, DataTypePy type, int axis, int gather_mode) override;
  ...
  static void RegCustom(const std::string &nspace, const std::string &so_path, const std::string &bin_path);
