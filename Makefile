...
CFLGAS += -Wl,-z,relro,-z,now,-z,noexecstack -fstack-protector-all -D_FORTIFY_SOURCE=2
...
ifneq ($(sim),)
LD_FLAGS = -L${ASCEND_PATH}/toolkit/tools/simulator/Ascend$(sim)/lib -lruntime_camodel
